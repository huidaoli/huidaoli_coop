...
<html>
	<head>
		...
		<script type="text/javascript" src="front/js/formvalidator/formValidator-4.1.3.js"></script>
		<script type="text/javascript" src="front/js/formvalidator/formValidatorRegex.js"></script>
	...
	<![endif]-->
		...
		$(function() {
				...
				$("#sex").formValidator({onShow:"请选择性别",
				         onFocus:"请选择性别",
				         onCorrect:"合法"}).inputValidator({
				         min:1,
				         onError: "请选择性别"})
				$("#cooptype").formValidator({onShow:"请选择合作者类型",
				         onFocus:"请选择合作者类型",
				         onCorrect:"合法"}).inputValidator({
				         min:1,
				         onError: "请选择合作者类型"})
				...
				$(":checkbox[name='agree']").formValidator({
					onShow:"请勾选同意协议",
					onFocus:"请勾选同意协议",
					onCorrect:"OK"}).inputValidator({min:1,onError:"请勾选同意协议"});
	...
	<body>
		...
		<div class="container_12">
			...
			<div class="grid_12">
				...
				<div class="info_box ib_green">
					...
					<div id="main">
						<div id="content-area">
							<form method="post" id="formID" action="saveMember.action"  class="pp-form">
								<div>
									<label for="reg-un">
										手机号
									</label>
									<span class="required">*</span> 
									<input name="member.userName" id="username" maxlength="11">
								...
								<div>
									...
									<span class="required">*</span>
									<input name="member.realName" id="realname">
								...
								<div>
									...
									<span class="required">*</span>
									<s:select list="listDictBusstype" headerKey="" headerValue="请选择" listKey="dictId" listValue="dictName" name="member.cooptype" id="cooptype"></s:select>
								...
								<div>
								    <label for="textnotice">
									</label>
									<span class="required"></span>
									<span class="notice" style="height: 30px; line-height: 30px;"><strong>我已经阅读并同意
									<a href="javascript:void(0);" onclick="servies();">《本草品味用户协议和服务条款》</a>
									</strong> </span><input name="agree" type="checkbox" id="agree" checked="checked" style="width:20px;padding-left: 90px;float:none;">
								...
								<div style="padding-left: 150px; padding-top: 20px;">
										...
										-->
										<s:token></s:token>
										<input type="submit" name="regsub" id="regsub" value="立即注册" style="height:30px;background:#A9DB80;color:#588134;font-weight: bold;cursor:pointer;">
								</div>
							</form>
						</div>
					</div>
        ...
        ·                     您同意凯之渡得基于其自行之考虑，因任何理由，包含但不限于长时间未使用，或凯之渡认为您已经违反本服务协议的文字及精神，终止您的密码、帐号或本服务之使用（或服务之任何部分），并将您在本服务内任何内容加以移除并删除。您同意依本服务协议任何规定提供之本服务，无需进行事先通知即可中断或终止，您承认并同意，凯之渡可立即关闭或删除您的帐号及您帐号中所有相关信息及文件，及/或禁止继续使用前述文件或本服务。此外，您同意若本服务之使用被中断或终止或您的帐号及相关信息和文件被关闭或删除，凯之渡对您或任何第三人均不承担任何责任。</p>
    	    ...
    	    <p> ·                     7．4　如本协议中的任何条款无论因何种原因完全或部分无效或不具有执行力，本协议的其余条款仍应有效并且有约束力。
    	      ...
    	      <strong>·                     Email:office@can2do.com</strong>
    	      </p>
           </div>   
