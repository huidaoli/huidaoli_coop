	...
	<table width="100%" id="mytab" border="1" class="t1">
		<tr style="background-color: rgb(224,236,255)">
		  ...
		  <tr>
			...
			<td>
			<c:if test="${sys:hasPermission(706,sessionScope.aclMap)}">
				 <span style="padding-right:10px;cursor:pointer;"><img src='../themes/icons/action_check.png' title="审核通过" onclick="openUmheckDio('ok','<s:property value="#x.id" escape="false"/>','${projectid}')"/></span>
			</c:if>
			<c:if test="${sys:hasPermission(707,sessionScope.aclMap)}">
				 <span style="padding-right:10px;cursor:pointer;"><img src='../themes/icons/action_delete.png' title="审核不通过" onclick="openUmheckDio('no','<s:property value="#x.id" escape="false"/>','${projectid}')"/></span>
			</c:if>
			</td>
