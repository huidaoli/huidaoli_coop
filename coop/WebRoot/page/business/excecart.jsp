	...
	<script>
		...
		$(function(){
			...
			$('#tt').datagrid({
				...
				striped: true,
				singleSelect:true,
				url:'buse/getLeaveAjaxData.action?type=execcart',
				fitColumns:true,
				
							
				columns:[[
				    {title:'标题',field:'title',width:100},
				    {title:'上午打卡时间',field:'startTime',width:100},
				    {title:'下午打卡时间',field:'endTime',width:100},
...
<body>
	...
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			...
			<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="loadLeave('异常打卡申请','buse/toAddExceCart.action','add')">异常打卡申请</a>
			<!--  
