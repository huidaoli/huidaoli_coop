...
$(function(){
    ...
    $("#mytab").append("<tr><td colspan=\"3\"></td><td>数量合计:</td><td><input type=\"text\" name=\"agreement.ext.shuliangheji\"  value=\"<s:property value="agreement.ext.shuliangheji"/>\" id=\"shuliangheji\" style=\"width:100%;border:0;\"></td><td>金额合计:</td><td><input type=\"text\" name=\"agreement.ext.jineheji\"  value=\"<s:property value="agreement.ext.jineheji"/>\" id=\"jineheji\" style=\"width:100%;border:0;\"></td></tr>");
...
<div style="width:80%;margin: 0 auto;">
		...
		<p align="center"><strong><font  color="#000000" size="+2">采购合同</font></strong></p>
    	    ...
    	    <p><strong>乙方（卖方）：<input type="text" name="yifang" id="yifang"  style="width:200px;border:0; border-bottom: 1px solid #000 "  value="<s:property value="agreement.coopname"/>"></strong></p>
