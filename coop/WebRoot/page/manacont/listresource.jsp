	...
	<script type="text/javascript">
		...
		function getInfoById(opt)
		{
		     ...
		     if(rows.length!=1)
		     {
		         ...
		         var strinfo = opt=='edit'?'修改资源':'查看资源';
		         loadEdit(strinfo,'resource/getInfoById.action?opt='+opt+'&id='+ rows[0].id+'&cctype=${cctype}' ,opt);
		...
		function getInfoById2(opt,id)
		{
	         ...
	         var strinfo = opt=='edit'?'修改资源':'查看资源'
	         loadEdit(strinfo,'resource/getInfoById.action?opt='+opt+'&id='+id+'&cctype=${cctype}',opt);
...
<body>
	...
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			...
			<br><br>
			<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="loadEdit('资源','resource/loadEdit.action?cctype=${cctype}','add')">新增</a>
