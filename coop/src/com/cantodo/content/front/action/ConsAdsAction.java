 ...
 * @author tdy
 */
@Controller("consAdsAction")
@Scope("prototype")
public class ConsAdsAction extends BaseAction
{
    ...
    private Log logger = LogFactory.getLog(ConsAdsAction.class);
    ...
    public String saveOrUpdatecads()
    {
